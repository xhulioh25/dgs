...
use App\Models\Relations\RevisionableTrait;
...
{
    use BaseModelTrait, RevisionableTrait, SoftDeletes, HasManyPagesTrait, HasManyPostsTrait, HasManyEventsTrait, HasManyCommentsTrait;
