...
use App\Facades\GroupRepository;
...
//        parent::__construct();
    ...
    public function store()
    {
        ...
        try {
            ...
            Mail::queue('emails.newuser', $mail, function ($message) use ($mail) {
    ...
    public function update($id)
    {
        ...
        if ($changed) {
            ...
            Mail::queue('emails.groups', $mail, function ($message) use ($mail) {
                $message->to($mail['email'])->subject($mail['subject']);
            });
        }
    ...
    public function destroy($id)
    {
        ...
        Mail::queue('emails.admindeleted', $mail, function ($message) use ($mail) {
            $message->to($mail['email'])->subject($mail['subject']);
        });
    ...
    {
        $diff = Diff::compare('hello','hellos');
        if (!$user) {
